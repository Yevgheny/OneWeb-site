...
<div class="remodal-bg">
	<header class="main-header parallax-window" data-parallax="scroll" data-image-src="./images/main-header-bg.jpg">
<div class='stars'></div>
				...
				<div class="row">
					...
					<div class="col-md-offset-1 col-md-2">
						<div class="request-call">
							<a href="#modal" class="btn btn-green">Заказать звонок</a>
						</div>
					</div>
				</div>
				<div class="row">
